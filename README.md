...
[Telegram: @yorosama](https://t.me/yorosama) | [Данил Вольхин (vk.com)](https://vk.com) | [Мой Хабр](https://habr.com/ru/users/digtatordigtatorov/)
...
## DataAnalysisTools
- **Описание**: Курс MTS по аналитике.
- Домашние работы, экзамен и лекционные материалы.
- **Репозиторий**: [deneal123/DataAnalysisTools](https://github.com/deneal123/DataAnalysisTools)

### TimeCast
- **Описание**: Приложение для предсказания временных рядов продаж товаров в магазинах.
- **Стек**: FastAPI, React, классические и нейросетевые подходы.
- **Репозиторий**: [deneal123/TimeCast](https://github.com/deneal123/TimeCast)

### SpaceCube
- **Описание**: Приложение для симуляции частиц.
- **Стек**: C-CUDA, Kafka (Распределенные вычисления на нескольких VM).
- **Репозиторий**: [Prischli-Drink-Coffee/SpaceCube](https://github.com/Prischli-Drink-Coffee/SpaceCube)

### VideoOCR
- **Описание**: В разработке.
- **Стек**: Ultralytics, ...
- **Репозиторий**: [Prischli-Drink-Coffee/CVproject](https://github.com/Prischli-Drink-Coffee/CVproject)
